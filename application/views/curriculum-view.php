    	...
    	<div style="margin-top: 50px">
	    	<div style="padding: 0px 20px 20px 20px">
				...
				<table data-toggle="table" data-toolbar="#leaderboard-controls"
	               data-url="<?php echo base_url("index.php/json/getCurriculumSubjects/$program_code/$curriculum_year/$x/1"); ?>"
	    	...
	    	<div style="padding: 0px 20px 20px 20px">
	    		<h4> 2nd Semester </h4>
				<table data-toggle="table" data-toolbar="#leaderboard-controls"
	               data-url="<?php echo base_url("index.php/json/getCurriculumSubjects/$program_code/$curriculum_year/$x/2"); ?>"
	               data-pagination="false" data-page-list="[5, 10, 20, 50, 100, 200, 500]"
	               data-search="false" data-show-refresh="false">
	                <thead>
	                    <tr>
	    	...
	    	<div style="padding: 0px 20px 20px 20px">
	    		<h4> Summer </h4>
				<table data-toggle="table" data-toolbar="#leaderboard-controls"
	               data-url="<?php echo base_url("index.php/json/getCurriculumSubjects/$program_code/$curriculum_year/$x/3"); ?>"
	               data-pagination="false" data-page-list="[5, 10, 20, 50, 100, 200, 500]"
	               data-search="false" data-show-refresh="false">
	                <thead>
	                    <tr>
